...
/****** Object:  Database [OnlineShoppingSystem]    Script Date: 18-11-2021 16:12:10 ******/
CREATE DATABASE [OnlineShoppingSystem]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'OnlineShoppingSystem', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\OnlineShoppingSystem.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'OnlineShoppingSystem_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\OnlineShoppingSystem_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [OnlineShoppingSystem] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [OnlineShoppingSystem] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [OnlineShoppingSystem] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [OnlineShoppingSystem] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [OnlineShoppingSystem] SET QUERY_STORE = OFF
GO
